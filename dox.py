...
def dox():
    ...
    i = input("do you want to get info of this machine and the target ip?(yes/no): ")
    if i.lower() == "yes":
      ...
      print (" invalid ip address or invalid input!")
#thats to gather more info and store ips
dox()
